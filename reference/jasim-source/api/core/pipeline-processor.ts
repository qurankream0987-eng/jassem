...
export const PipelineStageSchema = z.object({
  ...
  skipIf: z.function({
    input: [z.record(z.string(), z.unknown())],
    output: z.boolean().or(z.promise(z.boolean())),
  }).optional(),
  // Transform output before passing to next stage
  transformOutput: z.function({
    input: [z.record(z.string(), z.unknown())],
    output: z.record(z.string(), z.unknown()).or(z.promise(z.record(z.string(), z.unknown()))),
  }).optional(),
...
export const PipelineSchema = z.object({
  ...
  onStageComplete: z.function({
    ...
    output: z.void().or(z.promise(z.void())),
  }).optional(),
  ...
  onError: z.function({
    input: [z.string(), z.instanceof(JASIMError)],
    output: z.void(),
  }).optional(),
});
