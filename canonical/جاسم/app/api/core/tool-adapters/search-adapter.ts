...
/**
 * This adapter is also used by the canonical runtime's read-only research
 * capability. Keep its public boundary independent from the legacy ToolRuntime
 * so a web-research request never imports unrelated effectful adapters.
 */
