...
export const AUTHORITY_KEYS: ReadonlySet<string> = new Set([
  ...
  "actioncompleted",
  "status",
  // World authority. A model may propose a world's STRUCTURE. It may never
  // say whose world it is, which scope is acting, what version is current,
  // that a policy allowed it or that somebody approved it. Mirrored as
  // `WORLD_AUTHORITY_KEYS` in `world-runtime.ts`, tested against this set.
  "scopeid",
  "tenantid",
  "businessid",
  "organizationid",
