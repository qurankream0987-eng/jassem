...
// ============================================
// COMMISSION SPLITS: Automatic payout tracking
// ============================================
export const commissionSplits = mysqlTable("commission_splits", {
  id: serial("id").primaryKey(),
  ...
  totalAmount: decimal("total_amount", { precision: 12, scale: 3 }).notNull(),
  vendorPayout: decimal("vendor_payout", { precision: 12, scale: 3 }).notNull(),
  platformCommission: decimal("platform_commission", { precision: 12, scale: 3 }).notNull(),
  jasimFee: decimal("jasim_fee", { precision: 12, scale: 3 }).notNull(),
  status: mysqlEnum("status", ["pending", "ready", "processing", "completed", "failed"]).default("pending"),
